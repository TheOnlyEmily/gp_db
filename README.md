...
assert all(i in expected_decendant_ids for i in db.get_decendant_ids(x_xor_y_id, above_depth=1)) # should pass
assert len(expected_decendant_ids) == len(db.get_decendant_ids(x_xor_y_id, above_depth=1)) # should pass
```